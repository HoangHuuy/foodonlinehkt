...
<div class="seller-title">
    <h3>Sửa sản phẩm</h3>
    <span class="note">Bạn có thể sửa đổi thông tin sản phẩm của bạn cho phù hợp</span>
</div>
<form class="container" action="{{ route('seller.updateProduct', ['id' => $product[0]->id]) }}" method="post"
    ...
    <div class="mb-3">
        ...
        <input type="file" class="form-control" id="exampleInputPassword1" name="image_product"
            value="{{ isset($product[0]->image_product) ? old('image_product', $product[0]->image_product) : 'imagedefault.jpg' }}">
    </div>
