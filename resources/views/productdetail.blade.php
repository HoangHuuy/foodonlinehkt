                                ...
                                <li class="pr-0">
                                    <div class="dropdown">
                                        <button type="button" id="dropdownMenuButton-3" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                            <img src="http://127.0.0.1:8000/assets/images/flag/1.jpg" alt="" /> English <i class="ion-ios-arrow-down"></i>
                                        </button>

                                        <ul class="dropdown-menu animation slideDownIn" aria-labelledby="dropdownMenuButton-3">
                                            <li>
                                                <a href="#"><img src="http://127.0.0.1:8000/assets/images/flag/1.jpg" alt="" /> English</a>
                                            </li>
                                            <li>
                                                <a href="#"><img src="http://127.0.0.1:8000/assets/images/flag/2.jpg" alt="" /> Français</a>
                                            </li>
                                        </ul>
                                    </div>
                                </li>
            ...
            <div class="header-top bg-white ptb-30px d-xl-block d-none">
                <div class="container">
                    <div class="row">
                        <div class="col-md-2">
                            <div class="logo">
                                <a href="index.html"><img class="img-responsive" src="http://127.0.0.1:8000/assets/images/logo/logo.png" alt="logo.jpg" /></a>
                            </div>
                        </div>
                            ...
                            <div class="product-details-img product-details-tab">
                                <div class="zoompro-wrap zoompro-2">
                                    <div class="zoompro-border zoompro-span">
                                        <img class="zoompro" src="http://127.0.0.1:8000/assets/images/product-image/22.jpg" data-zoom-image="assets/images/product-image/zoom/1.jpg" alt="" />
                                    </div>
                                </div>
                                    ...
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide">
                                            <a class="active" data-image="assets/images/product-image/22.jpg" data-zoom-image="assets/images/product-image/zoom/1.jpg">
                                                <img class="img-responsive" src="http://127.0.0.1:8000/assets/images/product-image/22.jpg" alt="" />
                                            </a>
                                        </div>
                                        <div class="swiper-slide">
                                            <a data-image="assets/images/product-image/21.jpg" data-zoom-image="assets/images/product-image/zoom/2.jpg">
                                                <img class="img-responsive" src="http://127.0.0.1:8000/assets/images/product-image/21.jpg" alt="" />
                                            </a>
                                        </div>
                                        <div class="swiper-slide">
                                            <a data-image="assets/images/product-image/23.jpg" data-zoom-image="assets/images/product-image/zoom/3.jpg">
                                                <img class="img-responsive" src="http://127.0.0.1:8000/assets/images/product-image/23.jpg" alt="" />
                                            </a>
                                        </div>
                                        <div class="swiper-slide">
                                            <a data-image="assets/images/product-image/6.jpg" data-zoom-image="assets/images/product-image/zoom/4.jpg">
                                                <img class="img-responsive" src="http://127.0.0.1:8000/assets/images/product-image/6.jpg" alt="" />
                                            </a>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-12">
                            <div class="product-details-content">
                                ...
                                <div class="pro-details-policy">
                                    <ul>
                                        <li><img src="http://127.0.0.1:8000/assets/images/icons/policy.png" alt="" /><span>Security Policy (Edit With Customer Reassurance Module)</span></li>
                                        <li><img src="http://127.0.0.1:8000/assets/images/icons/policy-2.png" alt="" /><span>Delivery Policy (Edit With Customer Reassurance Module)</span></li>
                                        <li><img src="http://127.0.0.1:8000/assets/images/icons/policy-3.png" alt="" /><span>Return Policy (Edit With Customer Reassurance Module)</span></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="feature-slider-wrapper swiper-wrapper">
                            ...
                            <article class="list-product">
                                <div class="img-block">
                                    <a href="single-product.html" class="thumbnail">
                                        <img class="first-img" src="http://127.0.0.1:8000/assets/images/product-image/6.jpg" alt="" />
                                        <img class="second-img" src="http://127.0.0.1:8000/assets/images/product-image/7.jpg" alt="" />
                                    </a>
                        ...
                        <div class="feature-slider-item swiper-slide">
                            <article class="list-product">
                                <div class="img-block">
                                    <a href="single-product.html" class="thumbnail">
                                        <img class="first-img" src="http://127.0.0.1:8000/assets/images/product-image/12.jpg" alt="" />
                                        <img class="second-img" src="http://127.0.0.1:8000/assets/images/product-image/13.jpg" alt="" />
                                    </a>
                                    <div class="quick-view">
                                        <a class="quick_view" href="#" data-link-action="quickview" title="Quick view" data-bs-toggle="modal" data-bs-target="#exampleModal">
                                            <i class="icon-magnifier icons"></i>
                        ...
                        <div class="feature-slider-item swiper-slide">
                            <article class="list-product">
                                <div class="img-block">
                                    <a href="single-product.html" class="thumbnail">
                                        <img class="first-img" src="http://127.0.0.1:8000/assets/images/product-image/14.jpg" alt="" />
                                        <img class="second-img" src="http://127.0.0.1:8000/assets/images/product-image/15.jpg" alt="" />
                                    </a>
                                    <div class="quick-view">
                                        <a class="quick_view" href="#" data-link-action="quickview" title="Quick view" data-bs-toggle="modal" data-bs-target="#exampleModal">
                                            <i class="icon-magnifier icons"></i>
                        ...
                        <div class="feature-slider-item swiper-slide">
                            <article class="list-product">
                                <div class="img-block">
                                    <a href="single-product.html" class="thumbnail">
                                        <img class="first-img" src="http://127.0.0.1:8000/assets/images/product-image/16.jpg" alt="" />
                        ...
                        <div class="feature-slider-item swiper-slide">
                            <article class="list-product">
                                <div class="img-block">
                                    <a href="single-product.html" class="thumbnail">
                                        <img class="first-img" src="http://127.0.0.1:8000/assets/images/product-image/18.jpg" alt="" />
                                        <img class="second-img" src="http://127.0.0.1:8000/assets/images/product-image/19.jpg" alt="" />
                                    </a>
                                    <div class="quick-view">
                                        <a class="quick_view" href="#" data-link-action="quickview" title="Quick view" data-bs-toggle="modal" data-bs-target="#exampleModal">
                                            <i class="icon-magnifier icons"></i>
                        ...
                        <div class="feature-slider-item swiper-slide">
                            <article class="list-product">
                                <div class="img-block">
                                    <a href="single-product.html" class="thumbnail">
                                        <img class="first-img" src="http://127.0.0.1:8000/assets/images/product-image/20.jpg" alt="" />
                                        <img class="second-img" src="http://127.0.0.1:8000/assets/images/product-image/21.jpg" alt="" />
                                    </a>
                                    <div class="quick-view">
                                        <a class="quick_view" href="#" data-link-action="quickview" title="Quick view" data-bs-toggle="modal" data-bs-target="#exampleModal">
                                            <i class="icon-magnifier icons"></i>
                        ...
                        <div class="feature-slider-item swiper-slide">
                            <article class="list-product">
                                <div class="img-block">
                                    <a href="single-product.html" class="thumbnail">
                                        <img class="first-img" src="http://127.0.0.1:8000/assets/images/product-image/22.jpg" alt="" />
                                        <img class="second-img" src="http://127.0.0.1:8000/assets/images/product-image/23.jpg" alt="" />
                                    </a>
                                    <div class="quick-view">
                                        <a class="quick_view" href="#" data-link-action="quickview" title="Quick view" data-bs-toggle="modal" data-bs-target="#exampleModal">
                                            <i class="icon-magnifier icons"></i>
                        ...
                        <div class="feature-slider-item swiper-slide">
                            <article class="list-product">
                                <div class="img-block">
                                    <a href="single-product.html" class="thumbnail">
                                        <img class="first-img" src="http://127.0.0.1:8000/assets/images/product-image/24.jpg" alt="" />
                                        <img class="second-img" src="http://127.0.0.1:8000/assets/images/product-image/25.jpg" alt="" />
                                    </a>
                                    <div class="quick-view">
                                        <a class="quick_view" href="#" data-link-action="quickview" title="Quick view" data-bs-toggle="modal" data-bs-target="#exampleModal">
                                            <i class="icon-magnifier icons"></i>
                        ...
                        <div class="feature-slider-item swiper-slide">
                            <article class="list-product">
                                <div class="img-block">
                                    <a href="single-product.html" class="thumbnail">
                                        <img class="first-img" src="http://127.0.0.1:8000/assets/images/product-image/26.jpg" alt="" />
                                        <img class="second-img" src="http://127.0.0.1:8000/assets/images/product-image/27.jpg" alt="" />
                                    </a>
                                    <div class="quick-view">
                                        <a class="quick_view" href="#" data-link-action="quickview" title="Quick view" data-bs-toggle="modal" data-bs-target="#exampleModal">
                                            <i class="icon-magnifier icons"></i>
                        ...
                        <div class="feature-slider-item swiper-slide">
                            <article class="list-product">
                                <div class="img-block">
                                    <a href="single-product.html" class="thumbnail">
                                        <img class="first-img" src="http://127.0.0.1:8000/assets/images/product-image/28.jpg" alt="" />
                                        <img class="second-img" src="http://127.0.0.1:8000/assets/images/product-image/29.jpg" alt="" />
                                    </a>
                                    <div class="quick-view">
                                        <a class="quick_view" href="#" data-link-action="quickview" title="Quick view" data-bs-toggle="modal" data-bs-target="#exampleModal">
                                            <i class="icon-magnifier icons"></i>
                        ...
                        <div class="feature-slider-item swiper-slide">
                            <article class="list-product">
                                <div class="img-block">
                                    <a href="single-product.html" class="thumbnail">
                                        <img class="first-img" src="http://127.0.0.1:8000/assets/images/product-image/8.jpg" alt="" />
                                        <img class="second-img" src="http://127.0.0.1:8000/assets/images/product-image/9.jpg" alt="" />
                                    </a>
                                    <div class="quick-view">
                                        <a class="quick_view" href="#" data-link-action="quickview" title="Quick view" data-bs-toggle="modal" data-bs-target="#exampleModal">
                                            <i class="icon-magnifier icons"></i>
                        ...
                        <div class="feature-slider-item swiper-slide">
                            <article class="list-product">
                                <div class="img-block">
                                    <a href="single-product.html" class="thumbnail">
                                        <img class="first-img" src="http://127.0.0.1:8000/assets/images/product-image/10.jpg" alt="" />
                                        <img class="second-img" src="http://127.0.0.1:8000/assets/images/product-image/11.jpg" alt="" />
                                    </a>
                                    <div class="quick-view">
                                        <a class="quick_view" href="#" data-link-action="quickview" title="Quick view" data-bs-toggle="modal" data-bs-target="#exampleModal">
                                            <i class="icon-magnifier icons"></i>
